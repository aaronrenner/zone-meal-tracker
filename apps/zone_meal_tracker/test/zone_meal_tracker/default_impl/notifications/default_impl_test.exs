defmodule ZoneMealTracker.DefaultImpl.Notifications.DefaultImplTest do
  use ExUnit.Case, async: true

  import Mox

  alias ZoneMealTracker.DefaultImpl.Notifications.DefaultImpl
  alias ZoneMealTracker.DefaultImpl.Notifications.DefaultImpl.MockEmails
  alias ZoneMealTracker.DefaultImpl.Notifications.DefaultImpl.MockNotificationPreferenceStore
